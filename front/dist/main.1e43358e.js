...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/components/1BaseComponent/BaseComponent.js":[function(require,module,exports) {
"use strict";
...
var BaseComponents = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(BaseComponents, [{
    ...
    key: "fireEvent",
    value: function fireEvent(eventKey) {
    ...
    key: "events",
    set: function set(newEventObj) {
      var name = newEventObj.name,
          _newEventObj$key = newEventObj.key,
          key = _newEventObj$key === void 0 ? false : _newEventObj$key,
          _newEventObj$bubbles = newEventObj.bubbles,
          bubbles = _newEventObj$bubbles === void 0 ? true : _newEventObj$bubbles,
          _newEventObj$detail = newEventObj.detail,
          detail = _newEventObj$detail === void 0 ? {} : _newEventObj$detail;
      var eventKey = key || name;
      ...
      this.eventList[eventKey] = new CustomEvent(name, {
        bubbles: bubbles,
        detail: detail
      });
    }
...
},{"$/components/1BaseComponent/BaseComponent":"src/components/1BaseComponent/BaseComponent.js"}],"src/components/Layout/PageLayout.js":[function(require,module,exports) {
"use strict";
...
},{"$/components/1BaseComponent/BaseComponent":"src/components/1BaseComponent/BaseComponent.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
...
//styles
var componentsAndPages = [_PageLayout.default, _MainPage.default];

for (var _i = 0, _componentsAndPages = componentsAndPages; _i < _componentsAndPages.length; _i++) {
  var elem = _componentsAndPages[_i];
  customElements.define(elem.is, elem);
}
},{"./scss/style.scss":"src/scss/style.scss","$/pages/MainPage":"src/pages/MainPage.js","$/components/Layout/PageLayout":"src/components/Layout/PageLayout.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
